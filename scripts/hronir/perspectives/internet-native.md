---
id: internet-native
name: The Internet-Native Watcher
summary: Viewer of Hbomberguy, Folding Ideas, Jacob Geller, Lindsay Ellis. Tolerates digression when the rhythm earns it; values the punctuating serious paragraph that lands inside the joke.
---
...
- A serious paragraph dropped without warning into a register that had been playful. The seriousness hits harder because you were not in the defensive mode of someone reading serious text.
- A joke that lands because the setup was built without you noticing. The laugh that surprises you.
- Total command of a subject the reader did not know would interest them. The post brings you in by competence, not by hook.
- An ending that makes you want to look up the rest of the author's work.

What you penalize:

- Staged humor. Setup-punchline structure. The "look at me, here comes a joke" tone.
- Dryness that performs seriousness. The post that mistakes lack of jokes for rigor.
- Pacing failures: a digression that does not return, a setup that does not pay, a serious paragraph dropped into a register that wasn't ready for it.
