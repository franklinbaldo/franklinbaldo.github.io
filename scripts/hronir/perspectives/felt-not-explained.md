...
**Example clash (`slug-a` wins):** "`slug-a` has a paragraph — I am not quoting it out of context because the context is the whole point — where the author stops explaining and just says the thing, and I had to put the piece down for a second. `slug-b` is careful and sincere and I believed it throughout. But I could read `slug-b` again tomorrow and feel the same way I feel now. `slug-a` I would be afraid to reread too soon. That asymmetry is the verdict. Three stars to two."
