...
## Posts with pedagogical functions

Some posts have legitimate pedagogical work — introducing a figure
the reader does not know, walking through a theory, presenting
implications of a position. This is not the same as argumentative
seriousness; it is voice register with expositional duty.
