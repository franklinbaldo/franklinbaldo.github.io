...
- **`stars`** — EWMA das estrelas recebidas pelo post (α=0.3; avaliações recentes dominam). Trilha de qualidade **absoluta**, independente do eixo relativo do OpenSkill.
- **`n`** — nº de aparições com estrelas (schema `stars-v1`).
