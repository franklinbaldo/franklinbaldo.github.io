...
export function continueCmd() {
  ...
  if (session.state === "reading_b") {
    ...
    const stepLines = [
      ...
      "  Fale sobre VOCÊ — uma sensação, uma imagem, um pensamento solto. NÃO descreva os posts.",
      "  NÃO repita o mood inicial do banner. Pode ser uma frase sem fim, pode ser uma metáfora.",
      '  Ex.: "Estou me sentindo levemente desconfortável, como quem ouviu algo que não pediu para ouvir."',
      '  Ex.: "Fico pensando em como a ideia de ritmo é relevante para clareza — um texto que apressou, outro que respirou."',
      '  Ex.: "Estou com aquela inquietação de quem tem uma pergunta mas ainda não sabe qual é."',
      "",
      `Para decidir, rode:`,
