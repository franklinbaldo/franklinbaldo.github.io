...
export function continueCmd() {
  ...
  if (session.state === "reading_b") {
    ...
    const stepLines = [
      ...
      "- --after-mood: [OPCIONAL, máx. 250 chars] Como ficou seu estado interno DEPOIS de avaliar? Fale sobre VOCÊ, não sobre os posts.",
      ...
      '  Ex.: "Estou com mais energia do que quando comecei — inquieto de um jeito produtivo."',
      '  Ex.: "Estou cansado, como depois de uma discussão que valeu a pena mas cobrou seu preço."',
      '  Ex.: "Estou com aquela leveza de quem resolveu algo que nem sabia que estava incomodando."',
      "",
      `Para decidir, rode:`,
