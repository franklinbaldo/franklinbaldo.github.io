---
type: Blog Post
title: "O OVNI de Conde e a história que começou a arquivar a si mesma"
description: "Vi no Reddit um documento desclassificado sobre um suposto OVNI na Bahia em 1963. Fui procurar os jornais da época e acabei entrando na própria cadeia de arquivos que manteve a história viva."
docType: essay
date: "2026-08-07"
lang: pt
author: franklin
translationKey: conde-ufo-1963
tags:
  - história
  - arquivos
  - ovnis
...
```mermaid
flowchart LR
  A[Conde: fato, erro ou boato] --> B[Imprensa baiana]
  B --> C[Rádio Tupi]
  C --> D[FBIS]
  D --> E[Departamento de Estado]
  E --> F[Consulado em Salvador]
  F --> G[Jornais e investigação local]
  G --> H[Relatório diplomático]
  H --> I[Project Blue Book]
  I --> J[Digitalização]
  J --> K[Internet Archive]
  K --> L[Reddit]
  L --> M[ChatGPT + Hemeroteca]
  M --> N[Este post]
  N -. próxima captura .-> K
```
