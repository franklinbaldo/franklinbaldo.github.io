...
description: >-
  Sobre escrever o artigo antes de fazer a pesquisa, e outras práticas de
  engenharia que deveriam nos envergonhar menos do que envergonham.
type: essay
date: '2026-05-14'
lang: pt
...
tags:
  ...
  - tdd
  - ia
draftCreatedAt: '2026-06-16T22:00:18.929Z'
supersedes: 67810fcc-81c1-5d02-b23d-0dd74d6e20d4
draftMsg: Add narrative depth discussing intent in automated reproduction
draftCommittedAt: '2026-06-16T22:02:18.250Z'
---
...
Refletindo sobre a natureza da reprodução automatizada, há uma ironia sutil na forma como avaliamos a intenção. Quando Menard reescreve Cervantes, as palavras são idênticas, mas o peso histórico de seu ato muda o paradigma. Da mesma forma, quando uma máquina reconstrói um argumento, falta-lhe a experiência vivida do autor, tornando o texto matematicamente equivalente, mas filosoficamente distinto. Essa divergência entre processo e resultado é onde a verdadeira crítica deve mirar: não na superfície do texto, mas no fantasma que habita a sequência de geração da máquina.
