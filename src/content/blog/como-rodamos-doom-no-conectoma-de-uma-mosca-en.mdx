...
<div style="width: 100%; max-width: 1000px; margin: 2rem auto;">
  <iframe src="/flydoom/index.html" width="100%" height="820" style="border: 2px solid #30363d; border-radius: 8px; background: #0d1117;" title="FlyDoom: Drosophila Connectome Playing Doom in 3D" loading="lazy"></iframe>
</div>
...
- When odor concentration is stronger on the right antenna ($C_R > C_L$), the bilateral gradient drives turn torque towards the plume. As overall concentration increases, the circuit triggers a forward *surge* (accelerating straight towards food).
