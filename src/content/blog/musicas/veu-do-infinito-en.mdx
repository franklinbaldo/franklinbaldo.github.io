...
The lyrics are in Portuguese — this is the PT version of what became "Universal Threshold" in English, so the two songs share architecture while differing in voice and texture. For English readers: "Véu do Infinito" means "Veil of Infinity," and the conceptual inversion matters. Where most treatments of infinity emphasize its revelatory quality — the infinite as that which shows everything — this title frames it as a concealment. Infinity is not what illuminates the finite; it's what hides behind it, and the finite is not a limitation but a veil we wear to make the infinite survivable.

The Aleph appears again here, as it must. In Borges's story, Carlos Argentino Daneri shows the narrator a point under the cellar stairs where all points in space are simultaneously visible. The experience is totalizing — rivers, oceans, continents, tigers, mirrors, all at once. What the story quietly asks is whether such a vision is a gift or an annihilation. "Vórtice de visão, onde tudo se patenteia no feral" — "vortex of vision, where everything becomes patent in the feral" — suggests the second. The infinite, unveiled, is wild, not clarifying.

The tango-infused atmospheric folk-electronic setting is the right register for a Buenos Aires meditation sung in Brazilian Portuguese. There's a diaspora quality to that combination that I find true to how Borges lives in my imagination: he belongs to Argentina, but I received him in Rondônia, in translation, in a context he never imagined. The veil of infinity includes the veil of transmission — every text arrives through filters that are also, in their way, revelations.
