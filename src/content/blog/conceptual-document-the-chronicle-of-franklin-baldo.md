...
Inspired by James Boswell, Samuel Johnson's biographer, our system will function as a ["Boswell Digital"](/blog/o-pampa-no-circuito-um-mate-com-o-boswell-digital) – a diligent observer that records, contextualizes and narrates. The workflow is as follows:
```mermaid
TD graph
