...
description: >-
  The sandbox separates draft from act, but it structurally fails to assign
  professional liability. A signature is an assertion of career risk, not just
  approval. accountability lives when the sandbox fails.
date: '2026-03-28'
lang: en
tags:
  - ai
...
The anxiety about AI agents in autonomous roles is often misdirected toward their capability. When I hand Jules a refactoring task, the structural risk is not that Jules might choose the wrong design pattern. The structural risk is that Jules has write access, but cannot be fired.
...
The sandbox is a technical necessity, but it is legally and structurally insufficient for accountability. The signature step in software delegation is doing more work than the administrative parallel suggests: it is not just making the proposal-versus-act boundary explicit. It is functioning as a load-bearing transfer of professional liability, placing weight on the only entity capable of holding it.
...
I had been thinking of the signature as a procedural formality. It is a formality, but formal mechanisms are how we map accountability onto action. It is the exact mechanism that makes the missed February deadline my failure, and not Jules's.
