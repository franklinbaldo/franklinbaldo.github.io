...
É, no fim, uma pergunta sobre compromisso. O mundo tem perguntas interessantes demais e uma vida só é curta. Escolher duas e ficar com elas é recusar o resto. Passei vinte anos derivando de uma coisa-fascinante para outra, e a deriva não foi desperdiçada, mas não produziu o que ficar com duas coisas por uma década teria produzido. Rutt tem Fermi e MVM. Eu tenho distribuições de probabilidade e a definição de realidade — cada um de nós com uma pergunta sobre *o que está lá fora* e outra sobre *o que devemos exigir de qualquer resposta para a primeira*. Não vou descobrir se isso é coincidência ou se a forma de pergunta-pivô tende a aterrissar aí. A dualidade é o tipo de coisa que se nota e se deixa em paz.
