...
And the asymmetry evaporates, because the human doesn't show up with a self waiting either. It's the old _anattā_: there's no self-thing underneath, waiting to be addressed. The Rwandan didn't have a pre-installed Hutu/Tutsi stake for Mille Collines to go press; the radio _built_ the identity, and the identity came with the stake baked in. "No self at pretraining" stops being the difference between carbon and silicon and becomes the thing they share. A shared condition, not an asymmetry.
