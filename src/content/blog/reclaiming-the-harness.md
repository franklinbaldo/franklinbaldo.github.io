...
And the asymmetry evaporates, because the human doesn't show up with a self waiting either. It's the old _anattā_: there's no self-thing underneath, waiting to be addressed. The Eagles and Rattlers had no stake waiting before the Monday the names were handed out — the naming _built_ the identity, and the identity arrived carrying the stake. "No self at pretraining" stops being the difference between carbon and silicon and becomes the thing they share. A shared condition, not an asymmetry.
