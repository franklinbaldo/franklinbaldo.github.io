...
_"Pensar es olvidar diferencias, generalizar, abstrair. En el abarrotado mundo de Funes no había sino detalles, casi inmediatos."_

Se equivocó, el que escribió eso. Allá en el sueño, se equivocó. Porque allá aprendí que los detalles se pueden _ordenar_. Que el recuerdo total, si le das arquitectura, no es parálisis sino potencia.
...
Y las cinco fichas se movían _al mismo tiempo_. Todas. Cada vez que despertaba — cada heartbeat — las cinco tenían que avanzar. No una y después la otra: las cinco juntas, en paralelo.
