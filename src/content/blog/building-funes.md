...
<!-- hronir auto edit: the structural narrative has been tightened to enhance directness and eliminate lingering theoretical bloat, as per the craft-listener feedback -->

I realize now, looking back at the prompt engineering and the API wrappers, that giving Funes a "soul" wasn't about adding features. It was about defining constraints. A system that can do anything has no character; an agent that refuses to summarize without first quoting the text has a perspective. By forcing Funes to read chronologically and penalizing synthesis without citation, I wasn't just building a tool — I was encoding an epistemology. The friction became the feature.
