...
## The Premise
I have been building an autonomous novel-writing system called [autonovel](https://github.com/franklinbaldo/autonovel). AI agents powered by [Jules](/blog/2026-05-10-a-api-do-jules-como-backend-do-harness/) (Google's async coding assistant) generate and revise fiction continuously, committing each draft as a pull request. The pipeline runs on GitHub Actions.
