...
No projeto [Verne](/blog/2026-03-18-verne-identity-repo/), a solução é o que chamo de **padrão de repositório de identidade**.
...
```
### O fluxo de trabalho
Quando um agente como [Funes](/blog/funes-soul/) é acionado para trabalhar em uma tarefa (por exemplo, atualizar uma postagem de blog neste mesmo repositório):
...
- **[Jules](/blog/2026-05-10-jules-api-harness-backend/)** — agente de codificação assíncrona do Google Labs. [Jules](/blog/2026-05-10-jules-api-harness-backend/) acorda, lê a edição, faz o trabalho e abre o PR. Mesmo padrão, motor diferente.
