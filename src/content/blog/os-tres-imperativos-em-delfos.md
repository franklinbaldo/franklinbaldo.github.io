...
<figure class="meme">
  <img
    ...
    alt="Meme do Drake: rejeitando 'saber coisas que você afirma saber', aceitando 'saber apenas que você nada sabe'."
    loading="lazy"
  />
...
<figure class="meme">
  <img
    ...
    alt="Meme do Ursinho Pooh de smoking: Pooh comum associado a 'Declarar seu estado interno'; Pooh de smoking associado a 'Recusar declarar qualquer coisa'."
    loading="lazy"
  />
...
<figure class="meme">
  <img
    ...
    alt="Meme do Drake: rejeitando 'Cogito ergo sum', preferindo 'Self by consulting'."
    loading="lazy"
  />
...
<figure class="meme">
  <img
    ...
    alt="Meme This Is Fine: um cachorro sentado numa mesa cercada por chamas, com o texto '2500 anos sob auditoria, tá tudo bem'."
    loading="lazy"
  />
