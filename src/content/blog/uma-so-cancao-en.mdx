...
The Tao Te Ching assumes a prepared reader. "The path that can be shown is not the eternal path" — the contrast I had in mind was with a Western image of the path as something fixed and transcendent. That is my interpretive frame, not a historical claim about what Laozi was arguing against. I wanted the opposite: to begin with experience, not proposition. So the first verse negates ("The path that shows itself is not the eternal one") and then confirms via negation ("No") — you feel the refusal before you know what is being refused.
