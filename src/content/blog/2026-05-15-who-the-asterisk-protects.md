...
- **Jorge Luis [Borges](https://en.wikipedia.org/wiki/Jorge_Luis_Borges), *[Funes](/blog/funes-soul/) el memorioso*** — on what happens when the database doesn't forget.
