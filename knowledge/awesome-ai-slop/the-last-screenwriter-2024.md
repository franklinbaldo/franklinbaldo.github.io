...
name: 'Peter Luisi — The Last Screenwriter (2024)'
artifact_type: feature film
quality_tier: C
interest_tier: S
confidence: high
...
limitations:
  ...
  - 'A progressão dramática depende de arquétipos e reviravoltas familiares, e o texto frequentemente soa funcional e previsível apesar da produção competente, o que limita a força do filme quando separado da novidade de seu processo.'
  - 'A IA foi usada apenas na escrita: direção, atuação, fotografia, música, som, design e pós-produção foram humanos. O card portanto avalia um longa com roteiro gerado por IA, não um filme produzido end-to-end por modelos generativos.'
ai_mediation_evidence:
  - 'A página oficial do roteiro afirma que, depois do único input criativo inicial de Peter Luisi, trama, personagens, cenas, ações, reviravoltas e diálogos vieram exclusivamente do ChatGPT 4.0; a equipe humana selecionou cenas sugeridas pelo próprio modelo e as encurtou.'
  - 'O diretor declara no site oficial que não misturou cenas, não rearranjou ações ou palavras e não introduziu ideias próprias no roteiro, além do suporte necessário para continuar o processo de geração; o filme credita ChatGPT 4.0 como roteirista.'
  - 'A página de downloads disponibiliza a documentação completa do processo de escrita e o site do filme registra que o longa foi lançado gratuitamente em 5 de julho de 2024 com o objetivo explícito de tornar o experimento auditável e discutível.'
source_label: 'The Last Screenwriter — official screenplay documentation'
source_url: 'https://lastscreenwriter.com/the-screenplay/'
source_urls:
  - 'https://lastscreenwriter.com/about/'
  - 'https://lastscreenwriter.com/the-film/'
