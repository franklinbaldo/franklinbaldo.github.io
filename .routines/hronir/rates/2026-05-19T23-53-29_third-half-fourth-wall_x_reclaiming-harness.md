---
run_id: 2026-05-19T23-53-29
run_at: '2026-05-19T23:53:29Z'
match_index: 3
post_a:
...
review_b: >-
  ...
  insights mais afiados do corpus: pequena, verificável, com consequências
  grandes. A tabela com três linhas (humanos+Maslow, organizações+normas,
  LLM+harness) é genuinamente load-bearing — não decoração, mas argumento. O
  suporte empírico (Rwanda com efeito causal estimado por Yanagizawa-Drott,
  Robbers Cave com controle experimental, Bósnia observacional) é raro num post
  de blog de IA: Franklin não ficou em 'vibing'. A conexão ao canivete e ao
  Backend protocol transforma a tese em comprometimento real: ele construiu a
