---
run_id: 2026-05-19T13-12-34
run_at: '2026-05-19T13:12:34Z'
match_index: 7
post_a:
  key: three-hammers
...
review_b: >-
  ...
  única linha ('Lo normal es actuar, no pedir permiso') mudou o comportamento do
  agente mais do que qualquer lista de regras. A seção 'When the Narrative Is
  the Architecture' é o coração do argumento: quando spec e persona são o mesmo
  documento, alinhamento não é um problema separado para resolver. O fechamento
  — 'a diferença entre a persona e a alma' — é a melhor última frase de qualquer
  post do corpus. three-hammers tem a genealogia do paper (três propriedades
