...
- `franklinbaldo/papers` incorporou em `main` as auditorias `audits/prior-art/embedding-seeded-tournament-2026-09-17.md` e `audits/prior-art/interstitial-agent-2026-09-17.md`.
